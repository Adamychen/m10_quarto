...
La clave te la proporcionará el profesorado al inicio del módulo. Más detalles en [Herramientas → Configuración de la API key](06-herramientas.qmd#configuración-de-la-api-key-de-llamus).
:::
