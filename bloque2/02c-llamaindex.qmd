...
if not LLM_KEY:
    ...
    Settings.llm = LlamusChatLLM(model="mlx-community/Qwen3.6-35B-A3B-8bit", api_base=LLM_URL, api_key=LLM_KEY, temperature=0)
...
> **Lectura recomendada:** [LlamaIndex Documentation](https://docs.llamaindex.ai/en/stable/) [@llamaindex].
