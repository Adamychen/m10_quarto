...
| 2 | Agente analítico con Tool Calling | 4h | Script del agente con al menos 2 herramientas | [HPD 2](hpd2-agente-tool-calling.qmd) |
| 3 | Servidor MCP y conexión segura a datos locales | 4h | Servidor MCP funcional + análisis de riesgos | [HPD 3](hpd3-servidor-mcp.qmd) |
| 4 | Sistema RAG sobre datos mixtos con evaluación | 6h | Pipeline RAG evaluado con RAGAS (score > 0,6) | [HPD 4](hpd4-rag-mixto.qmd) |
