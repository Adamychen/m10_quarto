...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Adamychen/m10_quarto/blob/main/notebooks/evaluables/hpd4-datos-sinteticos.ipynb)
...
## Dataset de trabajo {#sec-hpd4-ds-dataset}
...
## Ejercicio 1 — Generar datos sintéticos con LLM (enfoque intuitivo) {#sec-hpd4-ds-ev1}
...
## Ejercicio 2 — KS test: datos reales vs. sintéticos {#sec-hpd4-ds-ev2}
...
## Ejercicio 3 — Utilidad downstream: clasificador con datos sintéticos {#sec-hpd4-ds-ev3}
...
## Ejercicio 4 — Comparación CTGAN vs. TVAE {#sec-hpd4-ds-ev4}
