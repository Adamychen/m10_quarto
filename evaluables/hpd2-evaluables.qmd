...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Adamychen/m10_quarto/blob/main/notebooks/evaluables/hpd2-evaluables.ipynb)
...
## Ejercicio 1 — Añade una herramienta de correlación (2.5 puntos) {#sec-hpd2-ev1}
...
## Ejercicio 2 — Precisión del agente (2.5 puntos) {#sec-hpd2-ev2}
...
## Ejercicio 3 — Detección de preguntas fuera de ámbito (2.5 puntos) {#sec-hpd2-ev3}
...
## Ejercicio 4 — Ground truth propio (2.5 puntos) {#sec-hpd2-ev4}
