...
prompt = ChatPromptTemplate.from_messages([
    ("system", "Eres un analista de datos del Titanic. Usa las herramientas disponibles. Responde en español."),
...
# El agente con create_tool_calling_agent recibe el historial en el prompt con {chat_history}
