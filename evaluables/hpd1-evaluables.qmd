...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Adamychen/m10_quarto/blob/main/notebooks/evaluables/hpd1-evaluables.ipynb)
...
## Ejercicio 1 — Añade un cuarto documento (2.5 puntos) {#sec-hpd1-ev1}
...
: Criterios de evaluación del Ejercicio 1 {#tbl-hpd1-ev1}
...
## Ejercicio 2 — Impacto del chunk size (2.5 puntos) {#sec-hpd1-ev2}
...
: Criterios de evaluación del Ejercicio 2 {#tbl-hpd1-ev2}
...
## Ejercicio 3 — Comparativa de modelos (2.5 puntos) {#sec-hpd1-ev3}
...
: Criterios de evaluación del Ejercicio 3 {#tbl-hpd1-ev3}
...
## Ejercicio 4 — Ground truth propio (2.5 puntos) {#sec-hpd1-ev4}
...
: Criterios de evaluación del Ejercicio 4 {#tbl-hpd1-ev4}
