...
- LLM: API Llamus US (`https://llamus.cs.us.es/api/v1`, modelo `mlx-community/Qwen3.6-35B-A3B-8bit`) o local (Ollama)
...
<!--  -->
<!-- Sección de ejercicios avanzados y entregable eliminada: pasan a ser el hpd4-entregable.qmd -->

::: {.callout-note icon=false}
## Trabajo posterior

Este taller te ha proporcionado un pipeline RAG funcional sobre datos mixtos.
El **[Entregable de HPD 4](../evaluables/hpd4-entregable.qmd)** te pide construir
un pipeline similar pero adaptado a tu **camino elegido** (Finanzas, Salud o
E-commerce), con tu propio corpus, tu base de datos y una evaluación completa
con RAGAS.
:::
