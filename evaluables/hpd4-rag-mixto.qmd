...
> **Duración:** 4h
>
> **Competencias:** [CE-4](../index.qmd#sec-competencias-especificas)
...
## 1.1 Generar los PDFs de informes trimestrales {#sec-hpd4-1-1-pdfs}
...
## 1.2 Crear tabla SQLite de productos {#sec-hpd4-1-2-sql}
...
## 2.1 Cargar y trocear los PDFs {#sec-hpd4-2-1-cargar}
...
## 2.2 Indexar PDFs en Chroma {#sec-hpd4-2-2-indexar-pdfs}
...
# Pista: mismo patrón que en HPD 1, sección 1.4 (Embeddings e indexación en Chroma)
...
## 2.3 Indexar productos SQL en Chroma {#sec-hpd4-2-3-indexar-sql}
...
# Pista: mismo patrón que HPD 1, sección 1.6 (embeddings de datos tabulares)
...
## 3.1 Función de búsqueda unificada {#sec-hpd4-3-1-busqueda}
...
## 6.1 Crear dataset de preguntas anotadas {#sec-hpd4-6-1-dataset}
...
## 6.2 Evaluar con RAGAS {#sec-hpd4-6-2-ragas}
...
## Tabla de evaluación {#sec-hpd4-tabla-evaluacion}
...
# Ejercicios {#sec-hpd4-ejercicios}

::: {.callout-tip icon=false}

### Para afianzar lo aprendido (~45 min) {#sec-hpd4-ejercicios-afianzar}
...
### Para seguir explorando (opcional) {#sec-hpd4-ejercicios-explorando}
