...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Adamychen/m10_quarto/blob/main/notebooks/01c-embeddings.ipynb)
...
![Arquitectura siamese de SBERT para inferencia.](../images/sbert_figure_2.png){#fig-sbert-arch fig-cap="Arquitectura siamese de SBERT para inferencia: dos torres BERT con pesos compartidos producen embeddings u y v que se comparan con cosine similarity. Adaptada de Reimers & Gurevych (2019), [Figure 2](https://aclanthology.org/D19-1410/), distribuida bajo CC-BY 4.0."}
