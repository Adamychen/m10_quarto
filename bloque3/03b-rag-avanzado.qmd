...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Adamychen/m10_quarto/blob/main/notebooks/03b-rag-avanzado.ipynb)
...
En el [HPD 1](../hpd1-embeddings.qmd) construiste un pipeline RAG básico: cargar PDFs, trocearlos en chunks, generar embeddings, indexar en Chroma y buscar por similitud coseno. Funciona, pero tiene limitaciones:
...
| **Ya lo viste en** | [HPD 1](../hpd1-embeddings.qmd) sección 1.6 | [02c-llamaindex.qmd](../bloque2/02c-llamaindex.qmd) sección SQL |
...
En el [HPD 4](../hpd4-rag-mixto.qmd) combinarás ambos caminos: búsqueda semántica en PDFs de informes + datos estructurados de una tabla de productos.
...
>
> Cuando estés listo, pasa al taller práctico: **[HPD 4 — Sistema RAG sobre datos mixtos](../hpd4-rag-mixto.qmd)**.
