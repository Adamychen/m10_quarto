...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Adamychen/m10_quarto/blob/main/notebooks/hpd1-embeddings.ipynb)
...
print("✓ Parte 1 limpiada (colección + corpus temporal eliminados)")
```
...
pdfs_descargados = [f for f in os.listdir(CORPUS_REAL) if f.endswith(".pdf")]
print(f"\nTotal PDFs en {CORPUS_REAL}: {len(pdfs_descargados)}")
